  ...
  const getDescription = () => {
    if (manageType === 'removeMembers') {
      return memberCount > 1
        ? `All members have been successfully removed from the ${group} list`
        : `${name} has been successfully removed from the ${group} list.`;
    } else if (manageType === 'addMembers') {
      return memberCount > 1
        ? `All members have been successfully added to the ${group} list`
        : `${name} has been successfully added to the ${group} list.`;
    } else {
